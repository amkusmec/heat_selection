...
source("06.figures/S12a.step_variance_all.R")
source("06.figures/S12b.step_variance_temp.R")
source("06.figures/S12c.step_cor_func.R")
...
ggsave("figures/revision1/step_variance_figure.png", gp, 
